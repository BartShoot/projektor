...
public class CinemaController {
    ...
    @GetMapping
    public PagedModel<CinemaSummaryDto> getCinemas(Pageable pageable) {
    ...
    public PagedModel<ShowingSummaryDto> getCinemaShowings(@PathVariable Integer id, Pageable pageable) {
