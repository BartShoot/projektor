...
public class CinemaSaver {
    ...
    public CinemaSaver(CinemaRepository cinemaRepository, CityRepository cityRepository, HeliosApiPort heliosApiPort, CinemaCityApiPort cinemaCityApiPort, MultikinoApiPort multikinoApiPort, CitySaver citySaver) {
                ...
                if (cityName != null) {
                    cityRepository.findByName(cityName).ifPresentOrElse(city -> {
                        ...
                        if (cinemaRepository.findByNameAndCinemaChain(multikinoCinema.cinemaName(), CinemaChain.MULTIKINO).isEmpty()) {
                            ...
                            log.info("Multikino cinema already exists: {} in city {}", multikinoCinema.cinemaName(), city.getName());
                        }
